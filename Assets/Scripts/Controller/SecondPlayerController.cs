...
namespace StarterAssets
{
    ...
    public class SecondPlayerController : MonoBehaviour
    {
        ...
        private SecondPlayerState _state;
        ...
        private void Start()
        {
            ...
            _elapsedTime = 0f;
            SetState(SecondPlayerState.Walk);
        ...
        private void Move()
        {
            ...
            switch (GetState())
            {
                ...
                case SecondPlayerState.Walk:
                    ...
                    {
                        SetState(SecondPlayerState.Wait);
                        _animator.SetFloat(_animIDSpeed, 0.0f);
                    }
                    break;

                case SecondPlayerState.Chase:
                    ...
                    {
                        SetState(SecondPlayerState.Block);
                        _animator.SetFloat(_animIDSpeed, 0.0f);
                    }
                    break;
            }
        ...
        {
            if (tempState == SecondPlayerState.Walk || tempState == SecondPlayerState.Block)
            {
                _elapsedTime = 0f;
                _state = tempState;
                CreateRandomPosition();
            }
            else if (tempState == SecondPlayerState.Chase)
            {
                _state = tempState;
                //　追いかける対象をセット
                playerTransform = targetObj;
            }
            else if (tempState == SecondPlayerState.Wait)
            {
                _elapsedTime = 0f;
                _state = tempState;
                velocity = Vector3.zero;
